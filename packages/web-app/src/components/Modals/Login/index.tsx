...
import { Button, Dialog, DialogContent, Form, Input } from "@pingtou/shadcn-ui";
...
export const LoginModal = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-[400px] overflow-hidden h-[551px] bg-color-b3 px-[50px] py-[33px]">
        <div
