...
export function Search() {
  ...
  return (
    <div ref={containerRef} className="absolute left-1/2 -translate-x-1/2 top-[12vh] w-[568px] transition-opacity duration-100">
      <div className={cn("bg-color-m1 flex h-[52px] rounded-xl overflow-hidden border border-color-white border-opacity-10 bg-opacity-60 search-box focus-within:bg-opacity-80", { "bg-opacity-80": showPopover })}>
      ...
      {showPopover && (
        <div
          className="engine-box glass-card mt-[4px] !border-color-white border-opacity-40 bg-color-m1 bg-opacity-80 dark:border-opacity-10 dark:bg-opacity-70 w-full"
        >
