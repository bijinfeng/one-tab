...
import { cn, Dropdown, type DropdownProps } from '@onetab/ui'
      ...
      >
        ...
        <div className="group relative w-full flex-grow py-4 space-y-2">
          {categoryGroup.map(item => (
            <CategoryItem key={item.id} data={item} showTitle={showCategoryTitle || isContainerHover} />
          ))}
        </div>
