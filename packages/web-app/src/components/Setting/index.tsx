...
export function Setting() {
  ...
  return (
    <>
      <IconButton onClick={() => setOpen(true)} size="huge" ghost className="home-setting-btn absolute left-[20px] bottom-[20px]">
        <Icon.Setting width={28} height={28} />
      </IconButton>

      <Dialog closable={false} open={open} onOpenChange={setOpen} className="flex w-[720px] max-w-[720px] h-[572px] max-h-[calc(100vh-88px)] p-0 overflow-hidden gap-0">
