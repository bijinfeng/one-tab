...
type ContentProps = Omit<React.ComponentPropsWithoutRef<typeof DropdownMenuContent>, 'content'>
...
export const Dropdown: FC<DropdownProps> = (props) => {
  const { open, defaultOpen, modal, onOpenChange, children, menuItems, onItemClick, ...rest } = props
